...
import sistemaAcademico.repository.TurmaAlunoRepository;
import sistemaAcademico.repository.TurmaRepositorio;

@SpringBootApplication
public class PrincipalClass implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(PrincipalClass.class, args);
	}
